    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[100dvh] p-4 bg-[#11111a] text-center relative overflow-hidden" dir="rtl">
        ...
        <div className="z-10 w-full max-w-[400px] p-6 sm:p-8 bg-[#1a1a2e]/80 backdrop-blur-xl border border-[var(--color-gold)]/20 rounded-3xl shadow-2xl flex flex-col items-center">
          ...
          <p className="text-[#bbb] mb-8 font-medium text-sm sm:text-base leading-relaxed px-2">العب واستمتع مع أصدقائك وكأنكم في مقهى حقيقي</p>
          ...
          <button 
            onClick={handleLogin}
            className="w-full py-4 bg-white text-black font-bold rounded-2xl flex items-center justify-center gap-3 active:scale-[0.97] transition-all shadow-[0_5px_20px_rgba(255,255,255,0.15)] hover:bg-gray-100 text-sm sm:text-base mt-2"
          >
